...
|  | [llamaindex_rag.ipynb](https://github.com/UpstageAI/cookbook/blob/main/llamaindex_rag.ipynb) | In this notebook, you will implement Retrieval-Augmented-Generation using the Lamindex-Upstage integration package. |
